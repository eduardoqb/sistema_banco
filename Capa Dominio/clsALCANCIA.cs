    ...
    class clsALCANCIA : clsCUENTA
    {
        #region 1: Atributos
            ...
            #region 1.2: Asociativos
                ...
                private ArrayList atrColMisObjAhorradores = new ArrayList();
            #endregion
        ...
        #region 2: Métodos
            #region 2.1: Constructor, Clonador, Comparador, Inicializador, Modificador y Destructor
                public clsALCANCIA(clsBANCO pObjCreador,int pOID,string pNombre) :base(pOID,pNombre)
                {
                    this.atrObjMiBanco = pObjCreador;
                    clsSERVIDOR_ASOCIACIONES.AsociarUnObjetoCon(this, pObjCreador.GetAlcancias());
                }
                public new void Destruir()
                {
                    base.Destruir();
                    //Disponer del Dinero (llevarlo a la billetera primero ahorrador), disociar Banco y Ahorradores.
                }
            #endregion
